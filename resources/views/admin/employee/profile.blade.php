...
@section('content')
    ...
    @if($employee->deleted_at)
        <div class="container btn-danger" style="padding: 10px">
            <h4 class="text-center"><i class="fa fa-ban" style="padding: 10px"></i>Colaborador removido da base de dados
            </h4>
        </div>
    @else
        <div class="container btn-success" style="padding: 10px">
            <h4 class="text-center"><i class="fa fa-plus-circle" style="padding: 10px"></i>Adicionar patrimônio ao
                colaborador</h4>
        </div>
    @endif
    <div class="container card text-center" style="padding: 20px">
        ...
        @if($employee->adress)
            <div class="row">
                <div class="col-sm">
                    <i class="fa fa-map-signs"></i>{{$employee->adress}},
                    nº {{$employee->adressNumber}}@if($employee->adressNumberInfo)
                        , {{$employee->adressNumberInfo}}@endif <br>
                </div>
            </div>
        @endif
    </div>
    ...
    @foreach($EmployeeAssignedEstates as $EmployeeEstate)
        ...
        <div class="container card-estate">
            ...
            <div class="estate-info flex col-sm-5">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        ...
                        <i class="fa fa-tag" style="font-size: 1.2em"></i> <span
                            style="font-size: 1.5em; padding-left: 0.2em;">Etiqueta: {{$EmployeeEstate->label_id}}</span><br>
                        <i class="fa fa-calendar" style="font-size: 1.2em"></i> <span
                            style="font-size: 1.5em; padding-left: 0.2em;">Concessão: {{date('d/m/Y', strtotime($EmployeeEstate->last_assign_date))}}</span><br>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="estate-options flex col-sm-5 row text-center">
                ...
                <a href="" onclick="unassignEstate({{$EmployeeEstate}}, {{$employee}})" data-toggle="modal"
                ...
                <a href="" onclick="writeOffEstate({{$EmployeeEstate}})" data-toggle="modal"
